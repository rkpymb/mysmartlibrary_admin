...
function DashboardCrypto({ OrderMainId }) {
    ...
    const UpdateOrder = async (e) => {
        ...
        const data = await fetch("/api/V3/Update/UpdateSalesOrder", {
            method: "POST",
            headers: {
            ...
            .then((parsed) => {
                ...
                if (parsed.ReqData.done) {
                    ...
                    router.push(`/ManageOrder/${OrderDataMain._id}`)
                } else {
    ...
    return (
        <>
            <Head>
                <title>Order : {OrderDataMain && OrderDataMain.Orderid}</title>
            </Head>
                ...
                <div className={MYS.TitleWithBackHeader}>
                    <div className={MYS.TitleWithBackHeaderA}>
                        ...
                        <div>
                            {!IsLoading ?
                                <div>
                                    <span>Order : {OrderDataMain.OrderTitle} </span>
                                </div>
                                : <div>
