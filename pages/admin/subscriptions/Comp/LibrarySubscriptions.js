...
import UserSubsCounter from './UserSubsCounter'
import CreateLbSubs from './CreateLbSubs'
...
const LibrarySubscriptions = () => {
    ...
    const GetData = async () => {
        ...
        try {
            const response = await fetch("/api/V3/Admin/LBSubscriptions/LBSubscriptionAll", {
                method: "POST",
                headers: {
    ...
    const DeleteShift = async (e) => {
        ...
        if (confirm(text) == true) {
            ...
            const data = await fetch("/api/V3/Admin/LBSubscriptions/DeleteLBSubscription", {
                method: "POST",
                headers: {
                    'Content-type': 'application/json'
                },
    ...
    const UpdateData = async () => {
        if (StatusText !== '' && validityStartDate !== '' && validityEndDate !== '') {
            ...
            const data = await fetch("/api/V3/Admin/LBSubscriptions/UpdateLBSubscription", {
                method: "POST",
                headers: {
                    'Content-type': 'application/json'
                },
