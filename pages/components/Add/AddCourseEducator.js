...
export default function ScrollDialog({ CourseMainData }) {
    ...
    const FinalAddEdu = async () => {
        ...
        if (EduUsername !== '') {
            ...
            const data = await fetch("/api/V3/Add/AddEducatortoCourse", {
                method: "POST",
                headers: {
                    'Content-type': 'application/json'
                },
                ...
                .then((parsed) => {
                    ...
                    if (parsed.ReqData.done) {
                        handleClose()
                        notify(`${EduName} Successfully added to this Course`)
                        router.push(`/coursedetails/${CourseMainData.pid}`)
    ...
    return (
        <div>
            ...
            >
                <DialogTitle id="scroll-dialog-title">Add Educator into this Course</DialogTitle>
