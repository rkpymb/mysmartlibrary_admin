...
import Addlivelecture from '../Add/Addlivelecture'
...
function RecentOrders({ chapterid, pid }) {
    ...
    useEffect(() => {
        const handleSubmit = async () => {
            ...
            const data = await fetch("/api/V3/List/Livelistbychapterid", {
                method: "POST",
                headers: {
            ...
            <div>
                ...
                <div className={MYS.TablevideotitleBox}>
                    ...
                    <div className={MYS.TablevideotitleBoxB}>
                        <Addlivelecture chapterid={chapterid} pid={pid} />
        ...
        {!isLoading &&
            <div>
                {Retdata.map((item, index) => {
                    return <div key={index} className={MYS.VideolistboxItem} onClick={() => router.push(`/LiveDetails/${item._id}`)}>
