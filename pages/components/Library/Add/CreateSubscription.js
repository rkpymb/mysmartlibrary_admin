...
export default function FullScreenDialog() {
    ...
    const Changeuser = async (e) => {
        ...
        if (UserMobile !== '' && mob.length == 10) {
            ...
            const data = await fetch("/api/V3/Library/User/GetUserDatabymobile", {
                method: "POST",
                headers: {
                    'Content-type': 'application/json'
                },
    ...
    const GetPasslist = async () => {
        ...
        const data = await fetch("/api/V3/Library/Passes/Passlistbybranchcode", {
            method: "POST",
            headers: {
                'Content-type': 'application/json'
            },
    ...
    const GetShiftlist = async () => {
        ...
        const data = await fetch("/api/V3/Library/Shifts/Shiftbybranchcode", {
            method: "POST",
            headers: {
                'Content-type': 'application/json'
            },
    ...
    const GetAddonslist = async () => {
        ...
        const data = await fetch("/api/V3/Library/Addons/LibraryAddonbybranchcode", {
            method: "POST",
            headers: {
                'Content-type': 'application/json'
            },
